...
class CompetenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competency" do
    assert_difference('Competency.count') do
      post competencies_url, params: { competency: { description: @competency.description, name: @competency.name, rank: @competency.rank } }
    end
  ...
  test "should update competency" do
    patch competency_url(@competency), params: { competency: { description: @competency.description, name: @competency.name, rank: @competency.rank } }
